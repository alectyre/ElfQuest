...
public class CharacterController2D : MonoBehaviour
{
	...
	public void OneWayPlayforms(bool toggle, float duration)
	{
		if(toggle)
		{
			platformMask |= oneWayPlatformMask;
			Invoke("TurnOffOneWayPlatforms", duration);
		}
		else
		{
			platformMask ^= oneWayPlatformMask;
			Invoke("TurnOnOneWayPlatforms", duration);
		}
	}

	public void OneWayPlayforms(bool toggle)
	{
		if(toggle)
			platformMask |= oneWayPlatformMask;
		else
	...
	private void TurnOnOneWayPlatforms() { platformMask |= oneWayPlatformMask; }
	private void TurnOffOneWayPlatforms() { platformMask ^= oneWayPlatformMask; }
